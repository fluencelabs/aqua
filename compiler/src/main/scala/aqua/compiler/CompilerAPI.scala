...
object CompilerAPI extends Logging {
  ...
  private def getAquaCompiler[F[_]: Sync, E, I: Order, S[_]: Comonad](
  ...
  def compile[F[_]: Sync, E, I: Order, S[_]: Comonad](
  ...
  def compileToContext[F[_]: Sync, E, I: Order, S[_]: Comonad](
    sources: AquaSources[F, E, I],
    parser: I => String => ValidatedNec[ParserError[S], Ast[S]],
    config: AquaCompilerConf
