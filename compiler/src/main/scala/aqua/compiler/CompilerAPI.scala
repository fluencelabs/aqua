...
object CompilerAPI extends Logging {
  ...
  private def toAquaProcessed[I: Order: Show, S[_]: Comonad](
  ...
  private def getAquaCompiler[F[_]: Monad, E, I: Order: Show, S[_]: Comonad](
  ...
  def compile[F[_]: Monad, E, I: Order: Show, S[_]: Comonad](
  ...
  def compileToContext[F[_]: Monad, E, I: Order: Show, S[_]: Comonad](
    sources: AquaSources[F, E, I],
    parser: I => String => ValidatedNec[ParserError[S], Ast[S]],
    config: AquaCompilerConf
