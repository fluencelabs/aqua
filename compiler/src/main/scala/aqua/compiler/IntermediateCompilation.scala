...
import aqua.semantics.header.{HeaderSem, HeaderSemActImpl}
...
object IntermediateCompilation extends Logging {
  ...
  private def handleLinked[I: Order, E, S[_]: Comonad](
    filesWithContext: Map[
      I,
      ValidatedNec[Err[I, E, S], NonEmptyMap[I, RawContext]]
    ]
  ): ValidatedNec[Err[I, E, S], Chain[AquaProcessed[I]]] = {
  ...
  def getLspAquaCompiler[F[_]: Monad, E, I: Order, S[_]: Comonad](
    ...
    new AquaCompiler[F, E, I, S, LspContext[S]](new HeaderSemActImpl[S, LspContext[S]](), semantics)
  }

  def getAquaCompiler[F[_]: Monad, E, I: Order, S[_]: Comonad](
    config: AquaCompilerConf
    ...
    new AquaCompiler[F, E, I, S, RawContext](new HeaderSemActImpl[S, RawContext](), semantics)
  }
